...
var productBtn = document.getElementById("product-container");
...
if (productBtn) {
  productBtn.addEventListener("click", function (e) {
    if (e.target.id === "product-btn") {
      ...
      var productIds = cart.map(function (e) {
        return e.id;
      });
      ...
      if (productIds.includes(item.id)) {
        ...
        e.target.classList = "w-full rounded-sm my-2 text-xs p-2 px-4 bg-green-400 text-white";
      } else {
        cart.push(item);
        e.target.classList = "w-full rounded-sm my-2 text-xs p-2 px-4 bg-red-400 text-white";
...
btns.forEach(function (el) {
  if (cartItems.cart.map(function (e) {
    return e.id;
  }).includes(el.dataset.id)) {
    el.classList = "w-full rounded-sm my-2 text-xs p-2 px-4 bg-red-400 text-white";
    el.innerText = "Remove";
  }
});
},{}],"_markup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports._cartmarkup = exports._alertmarkup = void 0;
...
exports._cartmarkup = _cartmarkup;
...
exports._alertmarkup = _alertmarkup;
},{}],"order.js":[function(require,module,exports) {
"use strict";

var _markup = require("./_markup");

var cartContainer = document.getElementById("cart-items");
var localCartItems = JSON.parse(localStorage.getItem("cart-products")) || {
  cart: []
};
var currentCartItems = localCartItems.cart;
...
function renderCartItems(userCart) {
  ...
  userCart.forEach(function (el) {
    var element = _markup._cartmarkup;
    element = element.replace("%CART_PHOTO%", el.photo);
    element = element.replace("%CART_PRICE%", "$ ".concat(el.price));
...
if (cartContainer) {
  ...
  cartContainer.addEventListener("click", function (e) {
    if (e.target.dataset.type === "minus" || e.target.dataset.type === "plus") {
      ...
      currentCartItems.forEach(function (el) {
...
},{"./_markup":"_markup.js"}],"alert.js":[function(require,module,exports) {
"use strict";
...
var alertType = ["success", "error", "info"];
...
function showAlert(message, type) {
  ...
  hideAlert();
  var borderColor = type === alertType[0] ? "green" : type === alertType[1] ? "red" : "yellow";
  var alertBox = _markup._alertmarkup;
  ...
  var oberver = window.setTimeout(hideAlert, 4000);
...
},{"./_markup":"_markup.js"}],"validator.js":[function(require,module,exports) {
"use strict";
...
function validateField(identifier, message) {
  var input = document.getElementById("".concat(identifier, "-input"));
  var label = document.getElementById("".concat(identifier, "-label"));

  if (label) {
    var errorMessage = "<span id=\"form-error\" class=\"text-right text-xs text-red-500 ml-auto\">".concat(message, "</span>");
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"checkout.js":[function(require,module,exports) {
"use strict";
...
var checkoutBtn = document.getElementById("place-order-button");
var firstName = document.getElementById("firstName-input");
var lastName = document.getElementById("lastName-input");
var mobile = document.getElementById("mobile-input");
...
function clearErrorNotification() {
  ...
  Object.keys(obj).map(function (el) {
    (0, _validator.validateField)(el, obj[el]);
  });
}
...
if (checkoutBtn) {
  ...
  regeneratorRuntime.mark(function _callee() {
    var formData, cartData, request, res, error;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartData = JSON.parse(localStorage.getItem("cart-products"));
            request = {
              user: formData,
              cart: cartData.cart
            };
            _context.next = 5;
            return _axios.default.post("/checkout", request);
          ...
          case 5:
            ...
            if (error) {
              Object.keys(error).map(function (el) {
                (0, _validator.validateField)(el, error[el]);
              });
            }

            console.log(res.data);
            (0, _alert.showAlert)(res.data.message, _alert.alertType[1]);
            return _context.abrupt("return");

          case 13:
            (0, _alert.showAlert)(res.data.message, _alert.alertType[0]);
            window.setTimeout(function () {
              location.assign("/payment/".concat(res.data.orderId));
            }, 1500);
...
},{"./alert":"alert.js","./validator":"validator.js","axios":"../../node_modules/axios/index.js"}],"payment.js":[function(require,module,exports) {
"use strict";
...
var expiryDate = document.getElementById("expiryDate-input");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _axios.default.post("/payment-confirmation", formData);
          ...
          case 11:
            ...
            window.setTimeout(function () {
              ...
              location.assign("/success/".concat(res.data.receipt));
            }, 1500);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./validator":"validator.js"}],"index.js":[function(require,module,exports) {
"use strict";
